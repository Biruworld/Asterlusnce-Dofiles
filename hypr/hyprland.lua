...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(dfb1b6ff)", "rgba(c0656fee)" }, angle = 45 },
...
-- Increasing or Decreasing window size keybinds.
--hl.bind("SUPER", "equal", function()
--hl.dispatch("resizeactive", "40 40")
--end)
